var audio = {};
  ...
  audio.tempo1.src = 'public/audio/fx-navi.mp3';

  audio.tempo2 = new Audio();
  audio.tempo2.src = 'public/audio/fx-streetfighter.mp3';

  audio.melody1 = new Audio();
  audio.melody1.src = 'public/audio/melody1.mp3';  

  audio.melody2 = new Audio();
  audio.melody2.src = 'public/audio/melody2.mp3';

  audio.beat1 = new Audio();
  audio.beat1.src = 'public/audio/beat1.mp3';

  audio.beat2 = new Audio();
  audio.beat2.src = 'public/audio/beat2.mp3';

  audio.vocals1 = new Audio();
  audio.vocals1.src = 'public/audio/vocals1.mp3';

  audio.vocals2 = new Audio();
  audio.vocals2.src = 'public/audio/vocals2.mp3';

  audio.synth1 = new Audio();
  audio.synth1.src = 'public/audio/ambience1.mp3';

  audio.synth2 = new Audio();
  audio.synth2.src = 'public/audio/ambience2.mp3';

  audio.synth3 = new Audio();
  audio.synth3.src = 'public/audio/ambience3.mp3';

  audio.synth4 = new Audio();
  audio.synth4.src = 'public/audio/ambience4.mp3';
...
audio.events = function() {
  ...
  $("input:checkbox").on('click', function() {
    ...
    $("form").find(".form__checkbox-input").each(function(){
